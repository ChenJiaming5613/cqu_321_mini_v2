<template>
  <view class="margin padding bg-white std-box-shadow std-border-radius radius text-lg std-bottom-margin-normal">
    ...
    <view class="text-left text-df margin-top-xs">[4] 如果遇到任何你认为是bug的课程信息，请及时前往反馈界面反馈或加入反馈qq群说明。</view>
    <view class="text-left text-df margin-top-xs">[5] 如果存在课程成绩分布信息与您认知不符的情况，以您为准。</view>
    <view class="text-left text-df margin-top-xs text-bold std-color-primary">[6] 成绩绝不代表老师的教学水平，重庆大学的每一位老师都十分优秀。</view>
  </view>
</template>
